...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const startH = window.innerWidth < 768 ? 280 : 400;
      ...
      media.style.width = `${currentW}px`;
      media.style.height = `${currentH}px`;
      media.style.borderRadius = `${currentR}px`;

      // Fade bg
      bg.style.opacity = `${1 - progress * 2}`;

      // Move titles
      const titleOffset = progress * 120;
      titleLeft.style.transform = `translateX(${-titleOffset}vw)`;
      titleRight.style.transform = `translateX(${titleOffset}vw)`;
    ...
    <section id="beranda" ref={containerRef} style={{ height: '280vh' }} className="relative">
      <div ref={stickyRef} className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div ref={bgRef} className="absolute inset-0 z-0">
          <AppImage
            src="https://images.unsplash.com/photo-1669155079396-d298d6196db6"
        ...
        <div
          ...
          <AppImage
            src="https://img.rocket.new/generatedImages/rocket_gen_img_1c658057b-1788323628082.png"
        ...
        {/* Expanded content — appears when hero fully expands */}
        <div
          ref={expandedRef}
